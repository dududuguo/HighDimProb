...
#check HighDimProb.traceMatrixExp_le_card_add_trace_support_mul_exp_sub_one_of_excessSupportDomination
...
#check HighDimProb.matrixLE_of_realMatrixToCStar_matrixLE
#check HighDimProb.realMatrixToCStar_log
#check HighDimProb.realMatrixToCStar_matrixLE
#check HighDimProb.realMatrixToCStar_strictlyPositive
#check HighDimProb.realMatrixToCStar_nonneg
...
#check HighDimProb.troppLogExpComparisonToK
...
#check HighDimProb.matrixSquare_centeredRandomMatrix_expectation_expansion
#check HighDimProb.centeredRankOneSquare_le_rankOneSecondMoment_statement
#check HighDimProb.centeredRankOneSquare_le_rankOneSecondMoment
...
#check HighDimProb.traceMatrixExp_le_rank_exp_lambdaMax_of_isStarProjection
