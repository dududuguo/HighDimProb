...
#check HighDimProb.matrixBernsteinTraceMGF_under_tropp
...
#check HighDimProb.matrixBernsteinQuadTail_trace_under_tropp
...
#check HighDimProb.matrixBernsteinQuadTail_scalar_under_tropp
#check HighDimProb.matrixBernsteinQuadraticFormUpperTailOptimizedScalarRHSWithBernsteinCoeff_under_primitives
#check HighDimProb.matrixBernsteinQuadTail_opt_under_tropp
...
#check HighDimProb.MatrixBernsteinPositiveSideTroppAssumptions
#check HighDimProb.MatrixBernsteinNegativeSideTroppAssumptions
#check HighDimProb.matrixBernsteinQuadTail_opt_of_tropp
#check HighDimProb.matrixBernsteinTwoSidedQuadraticFormTailOptimizedScalarRHSWithBernsteinCoeff_of_assumptions
#check HighDimProb.matrixBernsteinQuadTail_twoSided_opt_of_tropp
...
#check HighDimProb.matrixBernsteinOpNormTail_opt_of_tropp
#check HighDimProb.matrixBernsteinTwoSidedOptimizedScalarTailRHS_sameParameters
#check HighDimProb.one_le_matrixBernsteinTwoSidedOptimizedScalarTailRHS_zero
...
#check HighDimProb.SampleCovarianceTailTarget
#check HighDimProb.SampleCovarianceTailTarget.event
#check HighDimProb.SampleCovarianceTailTarget.rhs
#check HighDimProb.SampleCovarianceBoundedRowTroppAssumptions
#check HighDimProb.sampleCovariance_tail_optimized_under_boundedRowTroppAssumptions
#check HighDimProb.sampleCovariance_quadraticForm_tail_optimized_under_explicit_variance_proxy
#check HighDimProb.sampleCovariance_quadraticForm_tail_optimized_under_explicit_variance_proxy_of_troppPrimitive
...
#check HighDimProb.sampleCovariance_quadTail_centeredSq_exactRow_of_tropp
...
#check HighDimProb.sampleCovariance_opNormTail_centeredSq_exactRow_of_tropp
...
#check HighDimProb.MatrixVarianceProxyNormBound_centeredSampleCovarianceRowRankOneFamily_of_exactRowSqNorm_bound_memLp_two
#check HighDimProb.MatrixVarianceProxyNormBound_centeredSampleCovarianceRowRankOneFamilyNeg_direct_of_exactRowSqNorm_bound_memLp_two
