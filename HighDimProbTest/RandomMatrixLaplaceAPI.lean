...
variable (hBernsteinBound : TraceMGFBernsteinVarianceProxyBoundLIntegral P Y V theta R)
...
example :
  ...
  exact matrixLaplaceRHSLIntegral_le_of_traceMGFBernsteinVarianceProxyBoundLIntegral
    Y V theta t R hBernsteinBound
