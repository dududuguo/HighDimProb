...
| Hanson-Wright | `centeredQuadraticForm`, `deterministicFrobeniusNorm`, `hansonWrightUniversalConstant`, `hanson_wright_inequality_hdp_explicit_constant`, and the existential compatibility wrapper `hanson_wright_inequality_hdp`; finite real matrix and finite coordinate family, `K > 0`, `iIndepFun`, coordinate `HasSubgaussianMGF` at `K^2`, universal-constant Frobenius/operator min-form tail, no symmetry premise | [`HighDimProb/Concentration/HansonWright.lean`](../../HighDimProb/Concentration/HansonWright.lean) · [`HighDimProbTest/HansonWrightAPI.lean`](../../HighDimProbTest/HansonWrightAPI.lean) |
...
| Dudley entropy integral | `Dudley.truncatedBound`, `Dudley.fullBound`, and `Dudley.Inputs.bound`; the full consumer hides finite nets and derives measurability/integrability from uniformly continuous sample paths | [`Dudley.lean`](../../HighDimProb/Concentration/Dudley.lean), [`DudleyEntropyIntegral.lean`](../../HighDimProb/Concentration/DudleyEntropyIntegral.lean), and [`DudleyFull.lean`](../../HighDimProb/Concentration/DudleyFull.lean) |
| Gaussian functional foundations | standard-Gaussian integration by parts, two-variable affine stability, integral transport, and the Ornstein-Uhlenbeck coefficient specialization | [`HighDimProb/GaussianFunctional`](../../HighDimProb/GaussianFunctional) |
...
| Feature-Gram operator | `FeatureGramOperator.Inputs.ofIIndepFun`, normalized empirical/population deviation, Bernstein tail, high-probability radius, and Loewner sandwich | [`FeatureGramOperator.lean`](../../HighDimProb/RandomMatrix/FeatureGramOperator.lean) |
