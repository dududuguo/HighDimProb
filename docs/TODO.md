...
- Audit remaining negative-side operator-norm and trace-MGF assumptions in the sample-covariance route. Prefer named adapters over explicit duplicate fields.
