...
| Matrix Bernstein | trace-MGF, CFC/Tropp primitives, prefix/state bookkeeping, natural-state TraceExp route, reindex transport, optimized scalar RHS, quadratic-form and operator-norm wrappers | [`RandomMatrixAPI.md`](RandomMatrixAPI.md) |
