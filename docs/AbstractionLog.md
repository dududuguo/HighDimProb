...
- Keep experimental APIs under `HighDimProb.Experimental`, `HighDimProb.RandomMatrix`, or examples until tests, docs, and import-boundary checks justify promotion.
